...
HRESULT CRenderer::Initialize_Prototype()
{
	...
	/*_float4 vColor_Diffuse = { 1.f, 0.f, 1.f, 0.f };
	if (FAILED(m_pTarget_Manager->Add_RenderTarget(m_pDevice, m_pContext, TEXT("Target_Diffuse")
		, (_uint)Viewport.Width, (_uint)Viewport.Height, DXGI_FORMAT_R32G32B32A32_FLOAT, vColor_Diffuse)))
		return E_FAIL;*/
	/* For.Target_Normal */
	...
	_float4 vColor_EffectBloom = { 0.f, 0.f, 0.f, 0.f };
	...
	_float4 vColor_EffectBlurX = { 0.f, 0.f, 0.f, 0.f };
	...
	_float4 vColor_EffectBlurY = { 0.f, 0.f, 0.f, 0.f };
	...
	_float4 vColor_EffectCombineBlur = { 0.f, 0.f, 0.f, 0.f };
...
HRESULT CRenderer::Render_SSAOBlurY()
{
	...
	if (FAILED(m_pTarget_Manager->Bind_ShaderResourceView(TEXT("Target_SSAO"), m_pSSAOShader, "g_BlurXTexture")))
		return E_FAIL;
