...
public:
	...
	enum SHADEROPTION { OPT_DEFAULT, OPT_BY_ALPHA, OPT_BY_RED, OPT_BY_GREEN, OPT_BY_BLUE, OPT_NO_ZWRITE, OPT_BLACK_NO_DISCARD, OPT_ALPHATEST, OPT_RM_MAGENTA, OPT_END };
