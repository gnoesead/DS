...
public:
	...
	void Set_Fade_OutIn_Basic(_bool Fade, _float Time = 0.f);
...
private:
	...
	_bool m_Is_Fade_OutIn_Basic = { false };
	...
	_bool m_Is_Fade_OutIn_Basic_Done = { false };
