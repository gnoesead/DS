...
class Akaza_Awake_UI final : public CUI
{
...
private:
	Akaza_Awake_UI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	Akaza_Awake_UI(const Akaza_Awake_UI& rhs);
	virtual ~Akaza_Awake_UI() = default;
...
public:
	static Akaza_Awake_UI* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
