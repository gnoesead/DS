...
public:
	enum CUT_IN_FINISH { TANJIRO_FINISH, ZENITSU_FINISH, RENGOKU_FINISH, AKAZA_FINISH, TANJIRO_AWAKE , ZENITSU_AWAKE , RENGOKU_AWAKE, AKAZA_AWAKE, KYOGAI_AWAKE , TANJIRO_EXECUTION , END_FINISH };
