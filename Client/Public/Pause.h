...
private:
	CPause(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CPause(const CPause& rhs);
	virtual ~CPause() = default;
...
public:
	static CPause* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
