...
public:
	...
	enum INTERACTION_TYPE { INTERACTION_NONE, INTERACTION_DOOROPEN_MANUAL_L, INTERACTION_DOOROPEN_MANUAL_R, INTERACTION_DOOROPEN_AUTO, INTERACTION_ROOMCHANGE, INTERACTION_END };
