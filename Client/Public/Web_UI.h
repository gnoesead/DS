...
private:
	Web_UI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	Web_UI(const Web_UI& rhs);
...
public:
	static Web_UI* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
