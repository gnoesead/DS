...
class Zenitsu_Awake_UI final : public CUI
{
...
private:
	Zenitsu_Awake_UI(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	Zenitsu_Awake_UI(const Zenitsu_Awake_UI& rhs);
	virtual ~Zenitsu_Awake_UI() = default;
...
public:
	static Zenitsu_Awake_UI* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
