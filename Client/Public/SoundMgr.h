...
public:
	enum CHANNELID { BGM, PLAYER_IDLE,
		...
		SWORD_0, SWORD_1, SWORD_AWAKEN_0, SWORD_AWAKEN_1, SKILL_0, SKILL_1,
		MONSTER_MOVE_0, MONSTER_MOVE_1, MONSTER_EFFECT_0, MONSTER_EFFECT_1, MONSTER_VOICE, MONSTER_VOICE_SUB,
