...
public:
	enum CHANNELID {
		...
		SWORD_0, SWORD_1, SWORD_2, SWORD_3 , SWORD_4, SWORD_AWAKEN_0, SWORD_AWAKEN_1, SWORD_AWAKEN_2 , SWORD_AWAKEN_3 , SWORD_AWAKEN_4 , 
		SKILL_0, SKILL_1, SKILL_EFFECT, SKILL_EFFECT_0, SKILL_EFFECT_1, ZEN_AWAKE , ZEN_COMAWAKE_1 , ZEN_COMAWAKE_2,
		...
		AKAZA_VOICE_EFFECT,AKAZA_VOICE_TALK, AKAZA_VOICE_HIT, AKAZA_VOICE_HIT_2,AKAZA_ATK_EFFECT, AKAZA_ATK_EFFECT_2, AKAZA_HIT_EFFECT, AKAZA_MOVE_EFFECT,
		BULLET_HIT,
		TANJIRO_AWAKE, TANJIRO_AWAKE_2, TANJIRO_AWAKE_3,

		UI_CHANGE , UI_SELECT , UI_COMPLETE , UI_GAUGE , UI_STORY,
...
public:
	...
	void Play_Sound_Channel(TCHAR* pSoundKey, CHANNELID eID, _float _vol);
