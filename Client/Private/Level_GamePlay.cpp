...
HRESULT CLevel_GamePlay::Ready_Layer_Moster(const _tchar* pLayerTag)
{
	...
	CharacterDesc.WorldInfo.vPosition = _float4(143.f, 0.f, 143.f, 1.f);
	...
	CharacterDesc.WorldInfo.vPosition = _float4(137.f, 0.f, 137.f, 1.f);
...
// Monster_Hp
	...
	for (int i = 0; i < 3; i++) {
		...
		UIDesc11.m_Type = 0;
		UIDesc11.m_Monster_Index = i;
		UIDesc11.m_Up_Mount = 1.8f;
