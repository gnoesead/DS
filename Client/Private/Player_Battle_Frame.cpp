#include "pch.h"
#include "..\Public\Player_Battle_Frame.h"
...
CPlayer_Battle_Frame::CPlayer_Battle_Frame(const CPlayer_Battle_Frame & rhs)
	: CUI(rhs)
{
}

HRESULT CPlayer_Battle_Frame::Initialize_Prototype()
{
...
HRESULT CPlayer_Battle_Frame::Initialize(void * pArg)
{
	if (pArg != nullptr)
...
void CPlayer_Battle_Frame::Tick(_double TimeDelta)
{
...
void CPlayer_Battle_Frame::LateTick(_double TimeDelta)
{
...
HRESULT CPlayer_Battle_Frame::Render()
{
...
HRESULT CPlayer_Battle_Frame::Add_Components()
{
	/* For.Com_Renderer */
	...
	if (m_UI_Desc.m_Type == 0) {
		/* For.Com_Texture */
		if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Player_Battle_Frame"),
			TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
			return E_FAIL;
	}
	else if (m_UI_Desc.m_Type == 1) {
		/* For.Com_Texture */
		if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Player_Battle_Face"),
			TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
			return E_FAIL;
	}
	else if (m_UI_Desc.m_Type == 2) {
		/* For.Com_Texture */
		if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Player_Battle_Name"),
			TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
			return E_FAIL;
	}
...
HRESULT CPlayer_Battle_Frame::SetUp_ShaderResources()
{
...
void CPlayer_Battle_Frame::Set_UI()
{
...
void CPlayer_Battle_Frame::Get_Mouse_Pos()
{
...
void CPlayer_Battle_Frame::Change_Info(_double TimeDelta)
{
...
void CPlayer_Battle_Frame::Tool_Funtion(_double TimeDelta)
{
	//// Åø Àü¿ë 
...
CPlayer_Battle_Frame * CPlayer_Battle_Frame::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPlayer_Battle_Frame*		pInstance = new CPlayer_Battle_Frame(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CPlayer_Battle_Frame");
		Safe_Release(pInstance);
	}

	return pInstance;
}
CGameObject * CPlayer_Battle_Frame::Clone(void * pArg)
{
	CPlayer_Battle_Frame*		pInstance = new CPlayer_Battle_Frame(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CPlayer_Battle_Frame");
		Safe_Release(pInstance);
	}
...
void CPlayer_Battle_Frame::Free()
{
	__super::Free();
