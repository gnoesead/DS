...
void CPlayer_Rengoku::Animation_Control_Adventure_Move(_double dTimeDelta)
{
...
void CPlayer_Rengoku::Animation_Control_Adventure_Act(_double dTimeDelta)
{
...
void CPlayer_Rengoku::Player_Change(_double dTimeDelta)
{
