...
void CMonster_StealthZako::Trigger()
{
	//Hit_Trigger
...
void CMonster_StealthZako::Animation_Control_Idle(_double dTimeDelta)
{
...
void CMonster_StealthZako::Idle_ATK_Pattern_Controler(_double dTimeDelta)
{
	// Attack CoolTime
	if(m_isCoolTime_On)
...
void CMonster_StealthZako::Animation_Control_Attack(_double dTimeDelta, _int AttackIndex)
{	
	switch (AttackIndex)
	{
...
void CMonster_StealthZako::Animation_Control_Attack_Claws(_double dTimeDelta)
{
...
void CMonster_StealthZako::Animation_Control_Attack_Tackle(_double dTimeDelta)
{
	if (m_isFirst_AtkPattern)
	{
		m_isFirst_AtkPattern = false;
...
void CMonster_StealthZako::Animation_Control_Attack_Spinkick(_double dTimeDelta)
{
	if (m_isFirst_AtkPattern)
	{
		m_isFirst_AtkPattern = false;
...
void CMonster_StealthZako::Animation_Control_Attack_Jumpkick(_double dTimeDelta)
{
	if (m_isFirst_AtkPattern)
	{
		m_isFirst_AtkPattern = false;
...
void CMonster_StealthZako::Animation_Control_Attack_ButterFly(_double dTimeDelta)
{
	if (m_isFirst_AtkPattern)
	{
		m_isFirst_AtkPattern = false;
...
void CMonster_StealthZako::Animation_Control_Attack_Cross(_double dTimeDelta)
{
	if (m_isFirst_AtkPattern)
	{
		m_isFirst_AtkPattern = false;
...
void CMonster_StealthZako::Animation_Control_Attack_SpinMove(_double dTimeDelta)
{
	if (m_isFirst_AtkPattern)
	{
		m_isFirst_AtkPattern = false;
...
void CMonster_StealthZako::Animation_Control_Hit(_double dTimeDelta)
{
	CGameInstance* pGameInstance = CGameInstance::GetInstance();
	Safe_AddRef(pGameInstance);
...
void CMonster_StealthZako::Animation_Control_Down(_double dTimeDelta)
{
	_int iCurAnim = m_pModelCom->Get_iCurrentAnimIndex();
