...
#pragma region TANJIRO
	...
	if (FAILED(LoadEffects(TEXT("../Bin/DataFiles/Effect/Tanjiro/Tanjiro_Super2_Particle_rad3.bin"), true, 60)))
	{
		MSG_BOX("Failed to Load Effect : Tanjiro_Super2_Particle_rad3");
		return E_FAIL;
	}

	if (FAILED(LoadEffects(TEXT("../Bin/DataFiles/Effect/Tanjiro/Tanjiro_Super2_Particle_rad4.bin"), true, 60)))
	{
		MSG_BOX("Failed to Load Effect : Tanjiro_Super2_Particle_rad4");
		return E_FAIL;
	}
#pragma endregion
