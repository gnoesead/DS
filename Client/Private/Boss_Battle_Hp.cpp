#include "pch.h"
#include "..\Public\Boss_Battle_Hp.h"
...
CBoss_Battle_Hp::CBoss_Battle_Hp(const CBoss_Battle_Hp & rhs)
	: CUI(rhs)
{
}

HRESULT CBoss_Battle_Hp::Initialize_Prototype()
{
...
HRESULT CBoss_Battle_Hp::Initialize(void * pArg)
{
	if (pArg != nullptr)
...
void CBoss_Battle_Hp::Tick(_double TimeDelta)
{
...
void CBoss_Battle_Hp::LateTick(_double TimeDelta)
{
...
HRESULT CBoss_Battle_Hp::Add_Components()
{
	/* For.Com_Renderer */
...
HRESULT CBoss_Battle_Hp::SetUp_ShaderResources()
{
...
void CBoss_Battle_Hp::Get_Mouse_Pos()
{
...
void CBoss_Battle_Hp::Change_Info(_double TimeDelta)
{
...
void CBoss_Battle_Hp::Tool_Funtion(_double TimeDelta)
{
	//// Åø Àü¿ë 
...
{
	CBoss_Battle_Hp*		pInstance = new CBoss_Battle_Hp(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CBoss_Battle_Hp");
		Safe_Release(pInstance);
	}

	return pInstance;
}
CGameObject * CBoss_Battle_Hp::Clone(void * pArg)
{
	CBoss_Battle_Hp*		pInstance = new CBoss_Battle_Hp(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CBoss_Battle_Hp");
		Safe_Release(pInstance);
	}
