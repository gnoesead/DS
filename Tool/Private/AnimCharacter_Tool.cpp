...
HRESULT CAnimCharacter_Tool::Initialize(void* pArg)
{
	...
	Safe_AddRef(pGameInstance);
		...
		//★ 수정 필요
		strcpy_s(szFullPath, "../../Client/Bin/Resources/AnimToolBin/Zako_0.bin");
...
void CAnimCharacter_Tool::Save_Animations()
{
	...
	HANDLE hFindOut = ::FindFirstFileA("../../Client/Bin/Resources/Models/Character/Zako_0/*.bin", &fdFind);
...
{
	// for.Com_Model 
	if (FAILED(__super::Add_Component(LEVEL_TOOL, TEXT("Prototype_Component_Model_Monster_Zako_0"),
